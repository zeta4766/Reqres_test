...
from Reqres import settings
from Reqres.pages.base_page import BasePage
from Reqres.utils.dictionary_endpoints import endpoints_info
from Reqres.pages.locators import BaseLocator
